...
import { loadPushPreferences } from "@/lib/user-notifications";
...
export default function App() {
  useEffect(() => {
    ...
    // Prepara o áudio no primeiro gesto do usuário em qualquer tela, não só
    // quando a caixa de mensagens está aberta.
    ...
    // O registro/upgrade do Service Worker é responsabilidade exclusiva de main.tsx.
    // Este componente apenas observa mensagens do worker já registrado.
    ...
    const onMessage = (event: MessageEvent) => {
      ...
      if (data.type === "PUSH_PING") {
        ...
        // Alerta local quando o app está aberto. Em segundo plano, som,
        // vibração e apresentação são controlados pelo canal de notificações
        // do Android/iOS a partir de showNotification() no Service Worker.
        try {
